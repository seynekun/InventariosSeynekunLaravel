<div>
    <x-wire-card>
        ...
        <div class="mt-4">
            <x-wire-button green wire:click="importCategories" wire:loading.attr="disabled" wire:target="file"
                ...
                <div class="p-4 mb-3 text-yellow-800 bg-yellow-100 border border-yellow-300 rounded-md">
                    @if ($importedCount)
                        ...
                        <p class="mt-1 text-sm">
                            Algunas categorias no se pudieron importar debido a errores
                        </p>
                    @else
                        <i class="mr-2 fas fa-xmark"></i>
                        <strong>No se importo ninguna categoria</strong>
                        <p class="mt-1 text-sm">Todos las categoria tienen errores o el archivo no es valido</p>
                    @endif
                </div>
                <ul class="space-y-2">
